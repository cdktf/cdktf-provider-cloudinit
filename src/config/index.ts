// https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.6/docs/resources/config
...
export class Config extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Config that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.6/docs/resources/config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.6/docs/resources/config cloudinit_config} Resource
  *
  * @param scope The scope in which to define this construct
