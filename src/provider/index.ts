// https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.6/docs
...
export class CloudinitProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing CloudinitProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.6/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.3.6/docs cloudinit} Resource
  *
  * @param scope The scope in which to define this construct
